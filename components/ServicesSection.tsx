...
const SERVICES = [
  ...
  { file: 'service-smog-check.png',  name: 'Smog Check (Star Certified)',   popular: true  },
  { file: 'service-tune-up.png',     name: 'Engine Diagnostics & Tune-Up',  popular: true  },
  { file: 'service-brakes.png',      name: 'Brake Service',                 popular: true  },
  { file: 'service-tires.png',       name: 'Tire Service',                  popular: true  },
  { file: 'service-battery.png',     name: 'Battery & Electrical',          popular: false },
  { file: 'service-engine.png',      name: 'Transmission & Engine Repair',  popular: false },
  { file: 'service-ac.png',          name: 'AC & Heating',                  popular: false },
  { file: 'service-lube.png',        name: 'Auto Detailing',                popular: true  },
  { file: 'service-fluids.png',      name: 'Window Tinting',                popular: false },
  { file: 'service-diagnostics.png', name: 'Vehicle Registration Services', popular: false },
];
    ...
    <section id="services" data-screen-label="03 Services" style={{
      ...
      <div className="reveal-up" style={{
        ...
        <div style={{
          ...
          color: '#CC2020', fontSize: 13, fontWeight: 600,
          letterSpacing: '0.28em', textTransform: 'uppercase',
          marginBottom: 12,
          display: 'inline-flex', alignItems: 'center', gap: 16,
        }}>
          <span style={{ width: 40, height: 1, background: '#CC2020', display: 'inline-block' }} />
          What We Do
          <span style={{ width: 40, height: 1, background: '#CC2020', display: 'inline-block' }} />
        </div>
        <h2 style={{
      ...
      <div style={{
        ...
        <button
          ...
          onMouseEnter={e => { const b = e.currentTarget; b.style.background='#CC2020'; b.style.color='#fff'; b.style.borderColor='#CC2020'; b.style.transform='translateY(-50%) scale(1.1)'; }}
          onMouseLeave={e => { const b = e.currentTarget; b.style.background='#111111'; b.style.color='#CC2020'; b.style.borderColor='rgba(204,32,32,0.5)'; b.style.transform='translateY(-50%) scale(1)'; }}
        >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: isCenter
                    ? '0 28px 60px rgba(0,0,0,0.5), 0 0 0 2px rgba(204,32,32,0.5)'
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ color: '#CC2020', marginRight: 10 }}>
